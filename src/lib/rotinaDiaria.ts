...
const MANHA_COMUM: BlocoDia[] = [
  ...
  },
  {
    ...
    categoria: "refeicao",
    conselheiro: "Sêneca",
    principio: "Café sem feed. COM newsletter IA = aprendizado consciente.",
    detalhes:
      "Lê 1 newsletter de IA enquanto come (The Rundown AI / TLDR AI / Ben's Bites). 15min. Anota 1 insight aplicável.",
  },
  {
    inicio: "07:00",
    fim: "07:30",
...
export const ROTINA_QUINTA: BlocoDia[] = [
  {
    ...
    detalhes: "Roupa social. Revisa pitch 30s + indicação que vai pedir.",
  },
  {
    inicio: "05:00",
    fim: "05:30",
    ...
    categoria: "leitura",
    conselheiro: "Buffett",
    principio: "Sem academia hoje. Aproveita pra ler antes do BNI.",
  },
  {
    inicio: "05:30",
    fim: "05:50",
    ...
    detalhes: "5min de newsletter IA no celular enquanto come.",
  },
  {
    inicio: "05:50",
    fim: "06:00",
  ...
  },
  {
    ...
    detalhes:
      "Pitch 30s afiado. Anota TODO negócio. Pede 1 indicação específica. Conversas paralelas valem mais que o evento estruturado.",
  },
  {
    inicio: "10:00",
    fim: "10:30",
  ...
  },
  {
    ...
    categoria: "followup",
    conselheiro: "Hormozi",
    principio: "Follow-up BNI no MESMO DIA = ouro. Dia seguinte perde 70% do efeito.",
    detalhes:
      "WhatsApp pros membros relevantes. Agenda calls. Manda materiais. Convite pra cafézinhos individuais.",
  },
  {
    inicio: "12:00",
    fim: "13:00",
  ...
  },
  {
    inicio: "13:00",
    fim: "15:00",
    titulo: "💼 Cold Outreach (50 msgs) + Calls",
    categoria: "outreach",
    conselheiro: "Hormozi",
    principio: "Cold outreach OBRIGATÓRIO mesmo no dia de BNI. Sem exceção.",
    detalhes: "50 cold messages + calls agendadas.",
  },
  FOLLOWUP_BLOCO,
  {
    inicio: "16:00",
    ...
    categoria: "estudos",
    conselheiro: "Naval",
    principio: "IA é a fronteira. Aprender todo dia = leverage exponencial.",
    detalhes:
      "Curso, paper, framework. Veja fontes recomendadas na nota do dia.",
  },
  ...NOITE_COMUM,
];
